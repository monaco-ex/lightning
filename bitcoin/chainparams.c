...
const struct chainparams networks[] = {
    ...
    {.network_name = "monacoin",
     .bip173_name = "mona",
     .bip70_name = "main",
     .genesis_blockhash = {{{.u.u8 = {0xb6, 0x8b, 0x8c, 0x41, 0x0d, 0x2e, 0xa4,
              0xaf, 0xd7, 0x4f, 0xb5, 0x6e, 0x37, 0x0b,
              0xfc, 0x1b, 0xed, 0xf9, 0x29, 0xe1, 0x45,
              0x38, 0x96, 0xc9, 0xe7, 0x9d, 0xd1, 0x16,
              0x01, 0x1c, 0x9f, 0xff}}}},
     .rpc_port = 9402,
     .cli = "monacoin-cli",
     .cli_args = NULL,
     .cli_min_supported_version = 150000,
     .dust_limit = { 54600 },
     .max_funding = AMOUNT_SAT_INIT((u64)600 * ((1 << 24) - 1)),
     .max_payment = AMOUNT_MSAT_INIT((u64)600 * 0xFFFFFFFFULL),
     .when_lightning_became_cool = 1,
     .p2pkh_version = 50,
     .p2sh_version = 55,
     .testnet = false,
     ...
     .bip32_key_version = {.bip32_pubkey_version = BIP32_VER_MAIN_PUBLIC,
         .bip32_privkey_version = BIP32_VER_MAIN_PRIVATE},
     .is_elements =false },
    {.network_name = "monacoin-testnet",
     .bip173_name = "tmona",
     .bip70_name = "test",
     .genesis_blockhash = {{{.u.u8 = {0xb2, 0xe0, 0x61, 0x10, 0x32, 0x9c, 0x44,
              0x8f, 0x15, 0x78, 0xe4, 0x8a, 0x25, 0xa8,
              0x8b, 0x63, 0x9d, 0xcf, 0xaa, 0xa6, 0xa6,
              0xb2, 0x97, 0xd0, 0xc6, 0xe0, 0x3b, 0xba,
              0xce, 0x06, 0xb1, 0xa2}}}},
     .rpc_port = 19402,
     .cli = "monacoin-cli",
     .cli_args = "-testnet",
